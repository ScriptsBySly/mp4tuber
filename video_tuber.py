...
# ---------------- SAFE PRINT ----------------
# Thread-safe logging so prints don't collide between threads
...
class VideoPlayer:
    ...
    def select_new_video(self):
        ...
        safe_print(f"[StateMachine] New video requested: {requested_name}")
    ...
    def get_frame(self):
        ...
        # Peek near end without advancing
        ...
        while True:
            ...
            if threshold_passed:
                ...
                if not SOUND_DETECTED:
                    SOUND_DETECTED = True
                    LAST_NOISE_TIME = time_now
                elif (time_now - LAST_NOISE_TIME) > duration:
                    result = True
                    SOUND_DETECTED = False
            else:
                SOUND_DETECTED = False
